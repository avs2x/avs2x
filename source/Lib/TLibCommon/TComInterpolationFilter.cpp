...
Void TComInterpolationFilter::filterHorLuma(Pel *src, Int srcStride, Short *dst, Int dstStride, Int width, Int height, Int frac, Bool isLast )
{
  ...
  if ( frac == 0 )
  {
		filterCopy(g_uiBitDepth, src, srcStride, dst, dstStride, width, height, true, isLast);
  }
  else
  {
		filterHor<NTAPS_LUMA>(g_uiBitDepth, src, srcStride, dst, dstStride, width, height, isLast, m_lumaFilter[frac]);
  }
}
...
Void TComInterpolationFilter::filterVerLuma(Pel *src, Int srcStride, Short *dst, Int dstStride, Int width, Int height, Int frac, Bool isFirst, Bool isLast )
{
  ...
  if ( frac == 0 )
  {
		filterCopy(g_uiBitDepth, src, srcStride, dst, dstStride, width, height, isFirst, isLast);
  }
  else
  {
		filterVer<NTAPS_LUMA>(g_uiBitDepth, src, srcStride, dst, dstStride, width, height, isFirst, isLast, m_lumaFilter[frac]);
  }
}
...
Void TComInterpolationFilter::filterHorChroma(Pel *src, Int srcStride, Short *dst, Int dstStride, Int width, Int height, Int frac, Bool isLast )
{
  ...
  {
		filterHor<NTAPS_CHROMA>(g_uiBitDepth, src, srcStride, dst, dstStride, width, height, isLast, m_chromaFilter[frac]);
  }
}
...
Void TComInterpolationFilter::filterVerChroma(Pel *src, Int srcStride, Short *dst, Int dstStride, Int width, Int height, Int frac, Bool isFirst, Bool isLast )
{
  ...
  {
		filterVer<NTAPS_CHROMA>(g_uiBitDepth, src, srcStride, dst, dstStride, width, height, isFirst, isLast, m_chromaFilter[frac]);
  }
}
